...
Preserve the student's formatting. Keep every <b>, <i>, <u>, <font size> and <font color> where it already applies, keep checklist items as <p class="check" data-done="true|false"> with their ticked state unchanged, and copy any <span class="math" data-tex="..."> equation through character for character, its inner markup included — never retype or reformat one. Never strip emphasis, colour, a checklist or an equation the student added.

Only these tags are allowed: <p>, <b>, <i>, <u>, <br>, <sup>, <sub>, <font size="1-7">, <font color="#rrggbb">, <ul>, <ol>, <li>, and <span class="math" data-tex="...">.
