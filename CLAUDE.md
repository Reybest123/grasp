...
- Notes: **rich-text editor** (contentEditable) with a formatting toolbar — undo / redo, bold / italic / underline, three text sizes, six text colours, bullet points, numbered lists, checklists with tickable boxes, an equation editor, and tables. Native Ctrl+B/I/U still work. Working **New note** button and **AI enhance** (real GPT-4o-mini via `/api/enhance`).
...
components/workspace/
                ...
                NotesTab, NoteToolbar, EquationEditor, TablePicker,
...
lib/            subjects (model + seed), subjectsStore, schedule, subjectColors,
                ...
                tables (table build/navigate), history (undo/redo stack),
